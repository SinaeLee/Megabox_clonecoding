...
class Movie(models.Model) :
    ...
    movie_url_bg_poster = models.CharField(max_length=500) # 백그라운드 포스터 이미지 주소
    movie_url_poster = models.CharField(max_length=500)  # 포스터 이미지 주소
    movie_graph01 = models.CharField(max_length=500)  # 영화 그래프 - 관람포인트
    movie_graph03 = models.CharField(max_length=500)  # 영화 그래프 - 예매율
    movie_graph04 = models.CharField(max_length=500)  # 영화 그래프 - 일자별관객수
